export default {
  ...
  truco: {
    help: {
      ...
      objective_text_2: 'A partida é dividida em "Mãos". Cada mão vale inicialmente {{points}} ponto(s) e é disputada em uma "melhor de três" rodadas.',
      cards_title: 'FORÇA DAS CARTAS',
      cards_text: 'A hierarquia básica das cartas (da mais forte para a mais fraca) é:',
      cards_note: '* No "Baralho Limpo", retiram-se os 7, 6, 5 e 4 (exceto se forem manilhas).',
