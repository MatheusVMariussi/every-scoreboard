  ...
  const steps = [
    {
      ...
      content: (
        <View style={styles.stepContainer}>
          ...
          <Text style={styles.text}>
            {translate('truco.help.objective_text_2', {
              points: gameMode === 'paulista' ? '1' : '2',
            })}
          </Text>
    ...
    },
    {
      ...
      content: (
        <View style={styles.stepContainer}>
          <Text style={styles.text}>{translate('truco.help.cards_text')}</Text>
          ...
          <Text style={styles.note}>{translate('truco.help.cards_note')}</Text>
        </View>
      ),
    },
    {
      ...
      content: (
        <View style={styles.stepContainer}>
          <Text style={styles.text}>{translate('truco.help.manilhas_text')}</Text>

          {gameMode === 'paulista' ? (
            <>
              <Text style={styles.subTitle}>{translate('truco.help.manilha_variable_title')}</Text>
              <Text style={styles.text}>{translate('truco.help.manilha_variable_text')}</Text>
            ...
            <>
              ...
              <Text style={styles.text}>{translate('truco.help.manilha_fixed_text')}</Text>
              <View style={styles.cardsRow}>
              ...
              <Text style={styles.text}>(Zap &gt; 7 Copas &gt; Espadilha &gt; 7 Ouros)</Text>
            </>
          )}
        </View>
      ),
    },
    {
      ...
      content: (
        <View style={styles.stepContainer}>
          <Text style={styles.text}>{translate('truco.help.points_text')}</Text>
          <View style={styles.tablePoints}>
            ...
            <View style={styles.rowPoint}>
              ...
              <Text style={styles.val}>
                {translate('truco.help.tentos', { count: gameMode === 'paulista' ? 3 : 4 })}
              </Text>
            </View>
            <View style={styles.rowPoint}>
              <Text style={styles.lbl}>{translate('truco.help.points_table_six')}</Text>
              <Text style={styles.val}>
                {translate('truco.help.tentos', { count: gameMode === 'paulista' ? 6 : 8 })}
              </Text>
            </View>
            <View style={styles.rowPoint}>
              <Text style={styles.lbl}>{translate('truco.help.points_table_nine')}</Text>
              <Text style={styles.val}>
                {translate('truco.help.tentos', { count: gameMode === 'paulista' ? 9 : 10 })}
              </Text>
            </View>
            <View style={styles.rowPoint}>
          ...
          <Text style={styles.text}>{translate('truco.help.points_refuse_text')}</Text>
        </View>
      ),
    },
  ];
    ...
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
      <View style={styles.overlay}>
        <View
          style={[
            styles.container,
            { backgroundColor: '#F5F5F5', width: width * 0.95, maxHeight: height * 0.85 },
          ]}
        >
          {/* Header */}
